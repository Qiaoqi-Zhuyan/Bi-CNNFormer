...
class Bi_CnnFormer(nn.Module):
    def __init__(self, dims=None, layers=None, num_heads=None, img_size=224,
        ...
        # feat Fusion module
        self.AFB_stage1 = Attn_fusion_Block(dims[0], drop_rate)
        self.AFB_stage2 = Attn_fusion_Block(dims[1], drop_rate)
        self.AFB_stage3 = Attn_fusion_Block(dims[2], drop_rate)
        self.AFB_stage4 = Attn_fusion_Block(dims[3], drop_rate)
